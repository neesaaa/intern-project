...
const InstructorCard = ({ Rate, ImageUrl, Name, Title }) => {
    return (
        <div className="flex flex-col items-center gap-4 p-4 md:max-w-57 lg:max-w-67 xl:max-w-77  shadow-[0_0_8px_0_rgba(0,0,0,0.12)] text-black border border-border_color rounded-lg">
