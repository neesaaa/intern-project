...
const CourseCard = ({ Name, InstructorName,Rate,TotalLectures,TotlaHours,Cost,ImageUrl,Id  }) => {
    return (
        <Link to={`/courses/${Id}`} >
            <div className='flex flex-col  border cursor-pointer border-border_color p-4 gap-3 text-black rounded-xl shadow-[0_0_8px_0_rgba(0,0,0,0.12)] min-w-50 md:min-w-75 scrollbar-hide'>
                ...
                <div className='flex flex-col gap-3 '>
                    <div className='flex flex-col gap-3 '>
                        ...
                        <h5 className='text-sm'>{TotlaHours} Total Hours. {TotalLectures} Lectures. Beginner</h5>
                    </div>
