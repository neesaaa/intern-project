...
const AnimatedNumbersholder = () => {
    return (
        <div className='w-full flex flex-col md:flex-row items-center justify-between bg-slate-50 px-1 py-7 md:px-5 md:py-6 lg:px-20 lg:py-10 text-gray-900 text-xl md:text-3xl '>
